...
import { FaLaravel, FaNodeJs, FaReact } from 'react-icons/fa6';
...
const skills = [
  ...
  { name: 'Three.js', icon: <SiThreedotjs className='text-gray-800' /> },
  { name: 'GSAP', icon: <GsapIcon /> },
  { name: 'Node.js', icon: <FaNodeJs className='text-green-500' /> },
  { name: 'Laravel', icon: <FaLaravel className='text-red-500' /> },
  {
    name: 'Tailwind CSS',
    icon: <BiLogoTailwindCss className='text-cyan-400' />,
  },
];
...
const SectionSkills = () => {
    ...
    gsap.fromTo(
      ...
      { opacity: 0, y: 50, scale: 0.8 },
      {
        ...
        scrollTrigger: {
          ...
          start: 'top 508', // Mulai animasi saat 80% dari viewport
  ...
  return (
    <section
      id='skills'
      ref={sectionRef}
      className='bg-[#f8f8f8] h-screen flex flex-col justify-center text-center px-4'
    >
      <h2 className='text-6xl font-bold text-[#373737] mb-6'>My Skills</h2>
      ...
      <div className='flex flex-wrap justify-center gap-6'>
        {skills.map((skill, index) => (
          <div
            ...
            className='w-40 h-40  flex flex-col justify-center items-center p-6  bg-white shadow-md rounded-lg '
          >
            <div
